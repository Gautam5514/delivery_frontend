...
export default function WhyChooseUsSection() {
  ...
  return (
    <section className="w-full bg-white py-12 px-4 sm:px-6 lg:px-8 flex items-center justify-center">
      <div className="w-full max-w-[1200px]">
        <div className="grid lg:grid-cols-[0.9fr_1.1fr] gap-8 lg:gap-16 items-start">
          <div className="flex flex-col gap-6">
            <div className="relative w-full h-[320px] sm:h-[380px] mx-auto lg:mx-0 max-w-[450px]">
              <GraphicIllustration />
            </div>
            ...
            >
              ...
              <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 leading-tight mb-4">
                ...
                <span className="relative inline-block ml-2 z-0">
                  don&apos;t have to!
                  <span className="absolute -bottom-1 left-0 h-2 w-full bg-zinc-300 -z-10 rounded-sm"></span>
                </span>
              </h2>
            </motion.div>
          </div>
...
function FeatureCard({ feature, index, isActive, onHover }) {
  ...
  return (
    <div
      ...
      className={`relative p-8 transition-all duration-300 cursor-pointer h-full min-h-[240px] flex flex-col justify-center ${borderClass} ${
        isActive
          ? "bg-white shadow-[0_20px_40px_rgba(0,0,0,0.1)] z-10 scale-[1.03]"
          : "bg-transparent hover:bg-slate-50"
      }`}
    >
      <div className="mb-4">
        <Icon size={36} className="text-slate-700" strokeWidth={1.5} />
      </div>
  ...
  return (
    <div className="relative w-full h-full">
      <motion.div
        ...
        className="absolute top-[10%] left-[20%] w-[280px] h-[280px] z-0"
      >
      ...
      <div className="absolute top-0 left-0 w-[240px] h-[320px] bg-zinc-300 rounded-t-full rounded-b-3xl -rotate-3 z-10 shadow-md transform origin-bottom-left" />
      ...
      <motion.div
        ...
        className="absolute top-[40px] left-[30px] w-[200px] z-20"
      >
        <div className="relative rounded-[24px] border-[5px] border-slate-900 bg-slate-900 overflow-hidden shadow-2xl rotate-[-3deg]">
          ...
          <div className="absolute -right-4 bottom-12 w-12 h-20 bg-zinc-300 rounded-l-full z-30 opacity-90 shadow-sm" />
        </div>
      </motion.div>
      ...
      <motion.div
        ...
        className="absolute top-[15px] left-[150px] w-[220px] bg-white p-3 rounded-lg shadow-xl z-30 border border-slate-100"
      >
        <div className="flex items-center gap-2 mb-2">
          <div className="w-8 h-8 rounded-full overflow-hidden shrink-0 relative bg-slate-200">
            <Image
      ...
      <motion.div
        ...
        className="absolute bottom-[20px] left-[150px] w-24 h-24 rounded-full border-4 border-white shadow-lg overflow-hidden z-30 bg-slate-200 relative"
      >
        <Image
      ...
      <div className="absolute bottom-[80px] left-[60px] w-12 h-12 z-20 pointer-events-none">
      ...
      <div className="absolute top-[120px] right-[20px] w-16 h-24 z-10 pointer-events-none">
